...
const updateChildAbsence = async (childID) => {
  ...
  await ChildAttendance.findOneAndUpdate(
    { _childId: childID, _date: date },
    {
      $set: {
        _childDelay: false,
        _absence: true,
...
const updateEscortDelay = async (childID) => {
  ...
  await ChildAttendance.findOneAndUpdate(
    { _childId: childID, _date: date },
    { $set: { _escortDelay: true, _childId: childID, _date: date } },
    { upsert: true }
  );
};

// const deleteEscort = async (escortId) => {
//     await Escorts.delete({ _id: escortId, });
// }
  ...
  if ((typeof message !== "undefined") & childID) {
    switch (message) {
      ...
      case "Sickness":
        ...
        break;
      // case 'Delete Escort from system':
      //     ParentBot.sendMessage(chatId, "Please enter escort Id");
      //     break;
      // case !isNaN(messgae):
      //     await deleteEscort(escortID);
      //     ParentBot.sendMessage(chatId, "Escort deleted from system!");
      //     break;
      case "Other":
        ParentBot.sendMessage(chatId, "Thank you for letting me know!");
        break;
      ...
      default:
        ...
        ParentBot.sendMessage(
          chatId,
          "What would you like to inform me?",
          menu
        );
    }
  }
